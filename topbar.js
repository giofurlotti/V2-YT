...
// It self-injects HTML + CSS and gives every page the same
// Finance quick-link plus the bottom tab nav.
// =============================================================
(function () {
  'use strict';
...
`;
  ...
  // Any page loaded inside an iframe shouldn't render its own chrome again.
  function isEmbedded() {
